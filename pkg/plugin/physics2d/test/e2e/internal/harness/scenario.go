...
// DestroyShape deletes a shape entity through the system's entity handle. The shape API
// offers no delete; this is the bypass a game could still reach, and the hostile
