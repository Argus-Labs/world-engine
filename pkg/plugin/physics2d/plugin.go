...
// lists its shapes as ShapeRefs; the shapes themselves are entities you create through the
// Shapes search on a system state. Everything a system touches is in api.go, in the order a
// game meets it: bodies, shapes, queries, contact events. This file is the plugin instance
// and the raw-engine escape hatch.
//
