...
- **Cost**: The cost of running a crank is high as it requires a transactions to be sent to the smart contract at a fixed interval. This can be incredibly expensive if you are running a crank every second.
