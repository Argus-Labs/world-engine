...
- **System** — The logic in cardinal. They operate over entities that have a particular set of components, processing them to create the gameplay and behavior. A "MovementSystem", for example, might move all entities with a "Position" and "Speed" component each game tick.
...
3. **Implement queries:** Define queries that allow clients to read the game state.
