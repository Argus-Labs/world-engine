...
CQL allows you to use the name of [Component](/cardinal/game/component) to specify the entities that you want to query in Cardinal.
...
You can query all entities that has a health and attack component by using the following query:
