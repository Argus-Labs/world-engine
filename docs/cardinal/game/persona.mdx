...
The easiest way to set up a Persona Tag with your cardinal game is to use the [Cardinal plugin for Nakama](/client/nakama/overview). The `/nakama/claim-persona` RPC endpoint takes a request with a body of:
