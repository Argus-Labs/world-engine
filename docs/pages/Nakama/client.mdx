...
The [starter-game-template has a simple node JS client](https://github.com/Argus-Labs/starter-game-template/tree/main/.jsclient) that simply echos transaction receipts directly to the standard output.
