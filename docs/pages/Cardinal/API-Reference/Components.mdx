...
The `NewComponentType` function is used to create a new instance of a component type with customizable options. This function is designed to be generic, enabling it to accommodate any type, including those defined by users.
...
Component data can also be updated using the get/set methods described in the previous sections:
...
health.Amount -= 10
err = HealthComponent.Set(world, id, health)
if err != nil {
    return err
}
```
