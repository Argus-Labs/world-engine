...
Using the `inmem` package, you can get an instantiated `World` object that uses an in-memory data store, [miniredis](https://github.com/alicebob/miniredis). This is the simplest way to get started with building and testing your game. Do note however, this should NOT be used in production.
