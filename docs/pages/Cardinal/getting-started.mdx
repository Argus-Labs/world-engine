...
The state of your game shard can be inspected by visiting the [Cardinal Editor](https://editor.world.dev). Note, this will only be available after the game shard stack is running via `world cardinal start`.
