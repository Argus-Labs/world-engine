...
func NewHandler(w public.IWorld, opts ...Option) (*Handler, error) {
...
func newSwaggerHandlerEmbed(w public.IWorld, opts ...Option) (*Handler, error) {
	th := &Handler{
		w:   w,
...
func createAllEndpoints(world public.IWorld) (*EndpointsResult, error) {
