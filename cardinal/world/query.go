...
type Query interface {
	...
	HandleQueryEVM(WorldContextReadOnly, []byte) ([]byte, error)
...
func WithEVMSupport[Request, Reply any]() QueryOption[Request, Reply] {
...
func (r *queryType[Request, Reply]) HandleQueryEVM(wCtx WorldContextReadOnly, bz []byte) ([]byte, error) {
...
func (r *queryType[Request, Reply]) encodeEVMRequest(req any) ([]byte, error) {
	if r.requestABI == nil {
		return nil, eris.Wrap(message.ErrEVMTypeNotSet, "failed to ABI encode request")
	}
...
func (r *queryType[Request, Reply]) decodeEVMRequest(bz []byte) (*Request, error) {
	if r.requestABI == nil {
		return nil, eris.Wrap(message.ErrEVMTypeNotSet, "failed to ABI decode request")
	}
...
func (r *queryType[Request, Reply]) encodeEVMReply(a any) ([]byte, error) {
	if r.replyABI == nil {
		return nil, eris.Wrap(message.ErrEVMTypeNotSet, "failed to ABI encode reply")
	}
