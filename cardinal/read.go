...
func NewQueryType[Request any, Reply any](
	name string,
	handler func(ECSWorldContext, Request) (Reply, error),
...
func NewQueryTypeWithEVMSupport[Request, Reply any](name string, handler func(ECSWorldContext, Request) (Reply, error)) *QueryType[Request, Reply] {
	return &QueryType[Request, Reply]{
		impl: ecs.NewQueryType[Request, Reply](name, func(wCtx ecs.WorldContext, req Request) (Reply, error) {
			return handler(wCtx, req)
