...
type ReadType[Request, Reply any] struct {
	impl *engine.ReadType[Request, Reply]
}
...
func NewReadType[Request any, Reply any](
	...
	return &ReadType[Request, Reply]{
		impl: engine.NewReadType[Request, Reply](name, func(world *ecs.World, req Request) (Reply, error) {
