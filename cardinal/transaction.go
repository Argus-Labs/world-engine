...
func (t *TransactionType[Msg, Result]) GetReceipt(wCtx ECSWorldContext, hash TxHash) (r Result, errs []error, ok bool) {
...
func (t *TransactionType[Msg, Result]) In(wCtx ECSWorldContext) []TxData[Msg] {
