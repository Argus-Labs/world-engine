...
//
//	mockgen -source=cardinal/world_context.go -destination=cardinal/mocks/world_context_mock.go -package=mocks
//
...
import (
	...
	cardinal "pkg.world.dev/world-engine/cardinal"
...
func (m *MockWorldContext) ScheduleTickTask(arg0 uint64, arg1 cardinal.Task) error {
	m.ctrl.T.Helper()
...
func (m *MockWorldContext) ScheduleTimeTask(arg0 time.Duration, arg1 cardinal.Task) error {
	m.ctrl.T.Helper()
