...
func (m *MockProvider) GetMessageByID(arg0 message.TypeID) (message.Message, bool) {
	m.ctrl.T.Helper()
...
func (mr *MockProviderMockRecorder) GetMessageByID(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetMessageByID", reflect.TypeOf((*MockProvider)(nil).GetMessageByID), arg0)
}
