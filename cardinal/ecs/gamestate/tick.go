...
// be completed.
func (m *EntityComponentBuffer) GetTickNumbers() (start, end uint64, err error) {
...
func (m *EntityComponentBuffer) StartNextTick(txs []message.Message, queue *txpool.TxQueue) error {
	ctx := context.Background()
...
// to the DB.
func (m *EntityComponentBuffer) FinalizeTick(ctx context.Context) error {
...
func (m *EntityComponentBuffer) Recover(txs []message.Message) (*txpool.TxQueue, error) {
	ctx := context.Background()
