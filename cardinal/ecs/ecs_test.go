...
func UpdateEnergySystem(w *ecs.World, tq *transaction.TxQueue, _ *log.Logger) error {
	...
	Energy.Each(w, func(ent entityid.ID) bool {
...
func TestECS(t *testing.T) {
	...
	Energy.Each(world, func(id entityid.ID) bool {
...
func TestVelocitySimulation(t *testing.T) {
	...
	Velocity.Each(world, func(id entityid.ID) bool {
...
func TestCanRemoveEntity(t *testing.T) {
	...
	count := 0
	tuple.Each(world, func(id entityid.ID) bool {
...
func TestCanRemoveEntriesDuringCallToEach(t *testing.T) {
	...
	// of a problem
	Count.Each(world, func(id entityid.ID) bool {
...
func TestEntriesCanChangeTheirArchetype(t *testing.T) {
	...
	var count int
	countAgain := func() func(ent entityid.ID) bool {
		count = 0
		return func(ent entityid.ID) bool {
			count++
			return true
		}
	}
	...
	gamma.Each(world, func(id entityid.ID) bool {
...
func TestQueriesAndFiltersWorks(t *testing.T) {
	...
	ecs.NewQuery(abFilter).Each(world, func(id entityid.ID) bool {
	...
	ecs.NewQuery(cdFilter).Each(world, func(id entityid.ID) bool {
