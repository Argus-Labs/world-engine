...
// be checked.
func valueToComponentFilter(value *cqlValue, stringToComponent func(string) (icomponent.IComponentType, bool)) (filter.ComponentFilter, error) {
	if value.Not != nil {
		...
		components := make([]icomponent.IComponentType, 0, len(value.Exact.Components))
		...
		components := make([]icomponent.IComponentType, 0, len(value.Contains.Components))
...
func factorToComponentFilter(factor *cqlFactor, stringToComponent func(string) (icomponent.IComponentType, bool)) (filter.ComponentFilter, error) {
	return valueToComponentFilter(factor.Base, stringToComponent)
}

func opFactorToComponentFilter(opFactor *cqlOpFactor, stringToComponent func(string) (icomponent.IComponentType, bool)) (*cqlOperator, filter.ComponentFilter, error) {
...
func termToComponentFilter(term *cqlTerm, stringToComponent func(string) (icomponent.IComponentType, bool)) (filter.ComponentFilter, error) {
	if term.Left == nil {
...
func CQLParse(cqlText string, stringToComponent func(string) (icomponent.IComponentType, bool)) (filter.ComponentFilter, error) {
