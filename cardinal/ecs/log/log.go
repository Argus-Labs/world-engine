...
type Loggable interface {
	GetComponents() []component.IComponentMetaData
...
func (_ *Logger) loadComponentIntoArrayLogger(component component.IComponentMetaData, arrayLogger *zerolog.Array) *zerolog.Array {
...
func (l *Logger) loadEntityIntoEvent(zeroLoggerEvent *zerolog.Event, entityID entity.ID, archID archetype.ID, components []component.IComponentMetaData) (*zerolog.Event, error) {
	arrayLogger := zerolog.Arr()
...
func (l *Logger) LogEntity(level zerolog.Level, entityID entity.ID, archID archetype.ID, components []component.IComponentMetaData) {
	zeroLoggerEvent := l.WithLevel(level)
	var err error = nil
