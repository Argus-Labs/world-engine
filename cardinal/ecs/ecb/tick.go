...
func (m *Manager) StartNextTick(txs []message.Message, queue *txqueue.TxQueue) error {
	ctx := context.Background()
...
func (m *Manager) Recover(txs []message.Message) (*txqueue.TxQueue, error) {
	ctx := context.Background()
