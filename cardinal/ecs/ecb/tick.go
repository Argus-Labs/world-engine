...
func (m *Manager) StartNextTick(txs []message.Message, queue *tx_queue.TxQueue) error {
	ctx := context.Background()
...
func (m *Manager) Recover(txs []message.Message) (*tx_queue.TxQueue, error) {
	ctx := context.Background()
