...
func TestAddToQueueDuringTickDoesNotTimeout(t *testing.T) {
	...
	world.AddSystem(func(*ecs.World, *ecs.TransactionQueue, *zerolog.Logger) error {
		<-inSystemCh
		select {}
		return nil
	})
...
func TestTransactionsAreExecutedAtNextTick(t *testing.T) {
	...
	world.AddSystem(func(_ *ecs.World, queue *ecs.TransactionQueue, _ *zerolog.Logger) error {
