...
type Config struct {
	...
	// CardinalVerifySignature When false, Cardinal will not verify signatures.
	CardinalVerifySignature bool `mapstructure:"CARDINAL_SIGNATURE_VERIFICATION"`
...
func (w *Config) Validate() error {
	...
	if err := types.Namespace(w.CardinalNamespace).Validate(); err != nil {
