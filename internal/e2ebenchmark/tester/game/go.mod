module github.com/argus-labs/world-engine/example/tester_benchmark
...
replace (
	...
	pkg.world.dev/world-engine/cardinal/shard/adapter => ../../../../cardinal/shard/adapter
)

require (
	github.com/rotisserie/eris v0.5.4
	pkg.world.dev/world-engine/cardinal v1.0.7-beta.0.20240110211129-1e6779073813
)
