...
func (vbd EthValidateBasicDecorator) AnteHandle(ctx sdk.Context, tx sdk.Tx, simulate bool, next sdk.AnteHandler) (sdk.Context, error) {
	...
	for _, msg := range protoTx.GetMsgs() {
		...
		if !enableCreate && txData.GetTo() == nil {
			return ctx, sdkerrors.Wrap(evmostypes.ErrCreateDisabled, "failed to create new contract")
		} else if !enableCall && txData.GetTo() != nil {
			return ctx, sdkerrors.Wrap(evmostypes.ErrCallDisabled, "failed to call contract")
		}
