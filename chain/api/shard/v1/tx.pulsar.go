...
var (
	...
	fd_SubmitBatchRequest_batch  protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_SubmitBatchRequest_batch = md_SubmitBatchRequest.Fields().ByName("batch")
}
...
func (x *fastReflection_SubmitBatchRequest) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if len(x.Batch) != 0 {
		...
		if !f(fd_SubmitBatchRequest_batch, value) {
			return
		}
	}
}
...
func (x *fastReflection_SubmitBatchRequest) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "shard.v1.SubmitBatchRequest.sender":
		return x.Sender != ""
	case "shard.v1.SubmitBatchRequest.batch":
...
func (x *fastReflection_SubmitBatchRequest) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "shard.v1.SubmitBatchRequest.batch":
		panic(fmt.Errorf("field batch of message shard.v1.SubmitBatchRequest is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: shard.v1.SubmitBatchRequest"))
		}
...
func (x *SubmitBatchRequest) GetBatch() []byte {
	if x != nil {
		return x.Batch
	}
	return nil
...
var file_shard_v1_tx_proto_rawDesc = []byte{
	...
	,
...
var file_shard_v1_tx_proto_depIdxs = []int32{
	0, // 0: shard.v1.Msg.SubmitBatch:input_type -> shard.v1.SubmitBatchRequest
	1, // 1: shard.v1.Msg.SubmitBatch:output_type -> shard.v1.SubmitBatchResponse
