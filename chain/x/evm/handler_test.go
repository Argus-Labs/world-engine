...
func (suite *EvmTestSuite) DoSetupTest(t require.TestingT) {
	...
	suite.app = argus.Setup(checkTx, func(app *argus.ArgusApp, genesis simapp.GenesisState) simapp.GenesisState {
	...
	genesisState := argus.NewTestGenesisState(suite.app.AppCodec())
