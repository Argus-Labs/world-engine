...
func (m *TransactionBatch) GetNamespace() string {
	if m != nil {
		return m.Namespace
	}
	return ""
...
func (m *TransactionBatch) GetTick() uint64 {
	if m != nil {
		return m.Tick
	}
	return 0
...
func (m *TransactionBatch) GetBatch() []byte {
	if m != nil {
		return m.Batch
	}
	return nil
...
func init() {
	proto.RegisterType((*TransactionBatch)(nil), "shard.v1.TransactionBatch")
}
...
var fileDescriptor_0a60f84bb846c47b = []byte{
	...
	,
}
...
func (m *TransactionBatch) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.Batch) > 0 {
		i -= len(m.Batch)
		copy(dAtA[i:], m.Batch)
		i = encodeVarintTypes(dAtA, i, uint64(len(m.Batch)))
		i--
		dAtA[i] = 0x22
	}
	if m.Tick != 0 {
