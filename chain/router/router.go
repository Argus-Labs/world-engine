...
type Router interface {
	...
	Send(ctx context.Context, namespace, sender, msgID string, msg []byte) (*Result, error)
}
...
func (r *router) Send(ctx context.Context, _, sender, msgID string, msg []byte) (*Result, error) {
	req := &v1.MsgSend{
		Sender:    sender,
		MessageId: msgID,
		Message:   msg,
