...
type SubmitTransactionsRequest struct {
	...
	Transactions map[string]*Transactions `protobuf:"bytes,4,rep,name=transactions,proto3" json:"transactions,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (x *SubmitTransactionsRequest) GetTransactions() map[string]*Transactions {
	if x != nil {
