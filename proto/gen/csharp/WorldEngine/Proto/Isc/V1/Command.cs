...
namespace WorldEngine.Proto.Isc.V1 {
  ...
  /// <summary>Holder for reflection information generated from isc/v1/command.proto</summary>
  public static partial class CommandReflection {

    #region Descriptor
    /// <summary>File descriptor for isc/v1/command.proto</summary>
    ...
    static CommandReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            "ChRpc2MvdjEvY29tbWFuZC5wcm90bxIGaXNjLnYxGhtidWYvdmFsaWRhdGUv",
            "dmFsaWRhdGUucHJvdG8aHGdvb2dsZS9wcm90b2J1Zi9zdHJ1Y3QucHJvdG8a",
            "H2dvb2dsZS9wcm90b2J1Zi90aW1lc3RhbXAucHJvdG8aFGlzYy92MS9wZXJz",
            "b25hLnByb3RvGhZtaWNyby92MS9zZXJ2aWNlLnByb3RvIpcBCgdDb21tYW5k",
            "EigKCXNpZ25hdHVyZRgBIAEoDEIKukgHegJoQMgBAVIJc2lnbmF0dXJlEjUK",
            "CWF1dGhfaW5mbxgCIAEoCzIQLmlzYy52MS5BdXRoSW5mb0IGukgDyAEBUghh",
            "dXRoSW5mbxIrCg1jb21tYW5kX2J5dGVzGAMgASgMQga6SAPIAQFSDGNvbW1h",
            "bmRCeXRlcyKXAQoKQ29tbWFuZFJhdxJACgl0aW1lc3RhbXAYASABKAsyGi5n",
            "b29nbGUucHJvdG9idWYuVGltZXN0YW1wQga6SAPIAQFSCXRpbWVzdGFtcBIe",
            "CgRzYWx0GAIgASgMQgq6SAd6AmgQyAEBUgRzYWx0EicKBGJvZHkYAyABKAsy",
            "Ey5pc2MudjEuQ29tbWFuZEJvZHlSBGJvZHki7AEKC0NvbW1hbmRCb2R5EjMK",
            "BG5hbWUYAiABKAlCH7pIHHIXEAEYgAEyEF5bYS16QS1aMC05Xy1dKyTIAQFS",
            "BG5hbWUSOgoHYWRkcmVzcxgEIAEoCzIYLm1pY3JvLnYxLlNlcnZpY2VBZGRy",
            "ZXNzQga6SAPIAQFSB2FkZHJlc3MSMQoHcGVyc29uYRgDIAEoCzIPLmlzYy52",
            "MS5QZXJzb25hQga6SAPIAQFSB3BlcnNvbmESOQoHcGF5bG9hZBgBIAEoCzIX",
            "Lmdvb2dsZS5wcm90b2J1Zi5TdHJ1Y3RCBrpIA8gBAVIHcGF5bG9hZCK9AQoI",
            "QXV0aEluZm8SOQoEbW9kZRgBIAEoDjIZLmlzYy52MS5BdXRoSW5mby5BdXRo",
            "TW9kZUIKukgHggEEEAEgAFIEbW9kZRIxCg5zaWduZXJfYWRkcmVzcxgCIAEo",
            "DEIKukgHegJoIMgBAVINc2lnbmVyQWRkcmVzcyJDCghBdXRoTW9kZRIUChBN",
            "T0RFX1VOU1BFQ0lGSUVEEAASDwoLTU9ERV9ESVJFQ1QQARIQCgxNT0RFX1BF",
            "UlNPTkEQAkJZWjxnaXRodWIuY29tL2FyZ3VzLWxhYnMvd29ybGQtZW5naW5l",
  ...
  #endif
  {
    ...
    private global::WorldEngine.Proto.Isc.V1.AuthInfo.Types.AuthMode mode_ = global::WorldEngine.Proto.Isc.V1.AuthInfo.Types.AuthMode.ModeUnspecified;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    ...
    public override int GetHashCode() {
      int hash = 1;
      if (Mode != global::WorldEngine.Proto.Isc.V1.AuthInfo.Types.AuthMode.ModeUnspecified) hash ^= Mode.GetHashCode();
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      output.WriteRawMessage(this);
    #else
      if (Mode != global::WorldEngine.Proto.Isc.V1.AuthInfo.Types.AuthMode.ModeUnspecified) {
    ...
    public void MergeFrom(AuthInfo other) {
      ...
      if (other.Mode != global::WorldEngine.Proto.Isc.V1.AuthInfo.Types.AuthMode.ModeUnspecified) {
        Mode = other.Mode;
      }
    ...
    public static partial class Types {
      public enum AuthMode {
        [pbr::OriginalName("MODE_UNSPECIFIED")] ModeUnspecified = 0,
        [pbr::OriginalName("MODE_DIRECT")] ModeDirect = 1,
        [pbr::OriginalName("MODE_PERSONA")] ModePersona = 2,
      }
