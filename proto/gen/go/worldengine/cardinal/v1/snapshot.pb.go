...
func (x *WorldState) GetComponents() []string {
	if x != nil {
		return x.Components
	}
	return nil
...
type Entity struct {
	...
	Components []uint32 `protobuf:"varint,2,rep,packed,name=components,proto3" json:"components,omitempty"`
...
func (x *Entity) GetComponents() []uint32 {
	if x != nil {
		return x.Components
	}
	return nil
...
func (x *Entity) GetPayloads() [][]byte {
	if x != nil {
		return x.Payloads
	}
	return nil
...
var file_worldengine_cardinal_v1_snapshot_proto_goTypes = []any{
	...
	(*Entity)(nil),                // 2: worldengine.cardinal.v1.Entity
...
var file_worldengine_cardinal_v1_snapshot_proto_depIdxs = []int32{
	...
	2, // 2: worldengine.cardinal.v1.WorldState.entities:type_name -> worldengine.cardinal.v1.Entity
