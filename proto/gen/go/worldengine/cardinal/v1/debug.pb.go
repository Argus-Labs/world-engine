...
type PerfScheduleRequest struct {
	...
	MaxTicks      uint32 `protobuf:"varint,2,opt,name=max_ticks,json=maxTicks,proto3" json:"max_ticks,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *PerfScheduleRequest) GetMaxTicks() uint32 {
	if x != nil {
		return x.MaxTicks
	}
	return 0
...
func (x *PerfScheduleResponse) GetTruncated() bool {
	if x != nil {
		return x.Truncated
	}
	return false
...
const file_worldengine_cardinal_v1_debug_proto_rawDesc = "" +
	...
	"lastTickAt\x12\x15\n" +
	"\x06age_ms\x18\x03 \x01(\x03R\x05ageMs\"g\n" +
	"\x13PerfScheduleRequest\x123\n" +
	"\x0ewindow_seconds\x18\x01 \x01(\rB\f\xbaH\t\xc8\x01\x01*\x040\n" +
	"0<R\rwindowSeconds\x12\x1b\n" +
	"\tmax_ticks\x18\x02 \x01(\rR\bmaxTicks\"\x85\x02\n" +
	...
	"\x05ticks\x18\x05 \x03(\v2%.worldengine.cardinal.v1.TickTimelineR\x05ticks\x12\x1c\n" +
	"\ttruncated\x18\x06 \x01(\bR\ttruncated\"\xa5\x01\n" +
