...
const file_worldengine_isc_v1_query_proto_rawDesc = "" +
	"\n" +
	"\x1eworldengine/isc/v1/query.proto\x12\x12worldengine.isc.v1\x1a\x1bbuf/validate/validate.proto\x1a\x1cgoogle/protobuf/struct.proto\"\x9b\x02\n" +
	"\x05Query\x123\n" +
	...
	"\xbaH\a\x1a\x05\x18\x90N(\x00R\x05limit\x12\x1f\n" +
	"\x06offset\x18\x05 \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\x06offset\"C\n" +
	"\x05Match\x12\x15\n" +
	"\x11MATCH_UNSPECIFIED\x10\x00\x12\x0f\n" +
	"\vMATCH_EXACT\x10\x01\x12\x12\n" +
	"\x0eMATCH_CONTAINS\x10\x02\"B\n" +
	"\vQueryResult\x123\n" +
	"\bentities\x18\x01 \x03(\v2\x17.google.protobuf.StructR\bentitiesBeZHgithub.com/argus-labs/world-engine/proto/gen/go/worldengine/isc/v1;iscv1\xaa\x02\x18WorldEngine.Proto.Isc.V1b\x06proto3"
