...
replace (
	...
	github.com/argus-labs/world-engine/cardinal => ../../../cardinal
...
require (
	...
	buf.build/gen/go/argus-labs/world-engine/protocolbuffers/go v1.31.0-20230706220147-5852f366165d.1 // indirect
