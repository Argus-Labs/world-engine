...
func (_m *Satori) Authenticate(ctx context.Context, id string, ipAddress ...string) error {
...
//   - id string
//   - ipAddress ...string
func (_e *Satori_Expecter) Authenticate(ctx interface{}, id interface{}, ipAddress ...interface{}) *Satori_Authenticate_Call {
	return &Satori_Authenticate_Call{Call: _e.mock.On("Authenticate",
		append([]interface{}{ctx, id}, ipAddress...)...)}
}

func (_c *Satori_Authenticate_Call) Run(run func(ctx context.Context, id string, ipAddress ...string)) *Satori_Authenticate_Call {
...
func (_c *Satori_Authenticate_Call) RunAndReturn(run func(context.Context, string, ...string) error) *Satori_Authenticate_Call {
	_c.Call.Return(run)
	return _c
}
