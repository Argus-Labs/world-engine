...
func (_m *Initializer) RegisterAfterValidatePurchaseFacebookInstant(fn func(context.Context, runtime.Logger, *sql.DB, runtime.NakamaModule, *api.ValidatePurchaseResponse, *api.ValidatePurchaseFacebookInstantRequest) error) error {
	ret := _m.Called(fn)
...
// Initializer_RegisterAfterValidatePurchaseFacebookInstant_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'RegisterAfterValidatePurchaseFacebookInstant'
type Initializer_RegisterAfterValidatePurchaseFacebookInstant_Call struct {
	*mock.Call
}
...
func (_e *Initializer_Expecter) RegisterAfterValidatePurchaseFacebookInstant(fn interface{}) *Initializer_RegisterAfterValidatePurchaseFacebookInstant_Call {
	return &Initializer_RegisterAfterValidatePurchaseFacebookInstant_Call{Call: _e.mock.On("RegisterAfterValidatePurchaseFacebookInstant", fn)}
}

func (_c *Initializer_RegisterAfterValidatePurchaseFacebookInstant_Call) Run(run func(fn func(context.Context, runtime.Logger, *sql.DB, runtime.NakamaModule, *api.ValidatePurchaseResponse, *api.ValidatePurchaseFacebookInstantRequest) error)) *Initializer_RegisterAfterValidatePurchaseFacebookInstant_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *Initializer_RegisterAfterValidatePurchaseFacebookInstant_Call) Return(_a0 error) *Initializer_RegisterAfterValidatePurchaseFacebookInstant_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Initializer_RegisterAfterValidatePurchaseFacebookInstant_Call) RunAndReturn(run func(func(context.Context, runtime.Logger, *sql.DB, runtime.NakamaModule, *api.ValidatePurchaseResponse, *api.ValidatePurchaseFacebookInstantRequest) error) error) *Initializer_RegisterAfterValidatePurchaseFacebookInstant_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *Initializer) RegisterBeforeValidatePurchaseFacebookInstant(fn func(context.Context, runtime.Logger, *sql.DB, runtime.NakamaModule, *api.ValidatePurchaseFacebookInstantRequest) (*api.ValidatePurchaseFacebookInstantRequest, error)) error {
	ret := _m.Called(fn)
...
// Initializer_RegisterBeforeValidatePurchaseFacebookInstant_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'RegisterBeforeValidatePurchaseFacebookInstant'
type Initializer_RegisterBeforeValidatePurchaseFacebookInstant_Call struct {
	*mock.Call
}
...
func (_e *Initializer_Expecter) RegisterBeforeValidatePurchaseFacebookInstant(fn interface{}) *Initializer_RegisterBeforeValidatePurchaseFacebookInstant_Call {
	return &Initializer_RegisterBeforeValidatePurchaseFacebookInstant_Call{Call: _e.mock.On("RegisterBeforeValidatePurchaseFacebookInstant", fn)}
}

func (_c *Initializer_RegisterBeforeValidatePurchaseFacebookInstant_Call) Run(run func(fn func(context.Context, runtime.Logger, *sql.DB, runtime.NakamaModule, *api.ValidatePurchaseFacebookInstantRequest) (*api.ValidatePurchaseFacebookInstantRequest, error))) *Initializer_RegisterBeforeValidatePurchaseFacebookInstant_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *Initializer_RegisterBeforeValidatePurchaseFacebookInstant_Call) Return(_a0 error) *Initializer_RegisterBeforeValidatePurchaseFacebookInstant_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Initializer_RegisterBeforeValidatePurchaseFacebookInstant_Call) RunAndReturn(run func(func(context.Context, runtime.Logger, *sql.DB, runtime.NakamaModule, *api.ValidatePurchaseFacebookInstantRequest) (*api.ValidatePurchaseFacebookInstantRequest, error)) error) *Initializer_RegisterBeforeValidatePurchaseFacebookInstant_Call {
	_c.Call.Return(run)
	return _c
}
...
// RegisterStorageIndex provides a mock function with given fields: name, collection, key, fields, maxEntries, indexOnly
func (_m *Initializer) RegisterStorageIndex(name string, collection string, key string, fields []string, maxEntries int, indexOnly bool) error {
	ret := _m.Called(name, collection, key, fields, maxEntries, indexOnly)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(string, string, string, []string, int, bool) error); ok {
		r0 = rf(name, collection, key, fields, maxEntries, indexOnly)
	} else {
		r0 = ret.Error(0)
	}
...
// Initializer_RegisterStorageIndex_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'RegisterStorageIndex'
type Initializer_RegisterStorageIndex_Call struct {
	*mock.Call
}
...
//   - maxEntries int
//   - indexOnly bool
func (_e *Initializer_Expecter) RegisterStorageIndex(name interface{}, collection interface{}, key interface{}, fields interface{}, maxEntries interface{}, indexOnly interface{}) *Initializer_RegisterStorageIndex_Call {
	return &Initializer_RegisterStorageIndex_Call{Call: _e.mock.On("RegisterStorageIndex", name, collection, key, fields, maxEntries, indexOnly)}
}

func (_c *Initializer_RegisterStorageIndex_Call) Run(run func(name string, collection string, key string, fields []string, maxEntries int, indexOnly bool)) *Initializer_RegisterStorageIndex_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].(string), args[2].(string), args[3].([]string), args[4].(int), args[5].(bool))
	})
	return _c
}

func (_c *Initializer_RegisterStorageIndex_Call) Return(_a0 error) *Initializer_RegisterStorageIndex_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Initializer_RegisterStorageIndex_Call) RunAndReturn(run func(string, string, string, []string, int, bool) error) *Initializer_RegisterStorageIndex_Call {
	_c.Call.Return(run)
	return _c
}

// RegisterStorageIndexFilter provides a mock function with given fields: indexName, fn
func (_m *Initializer) RegisterStorageIndexFilter(indexName string, fn func(context.Context, runtime.Logger, *sql.DB, runtime.NakamaModule, *runtime.StorageWrite) bool) error {
...
// Initializer_RegisterStorageIndexFilter_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'RegisterStorageIndexFilter'
type Initializer_RegisterStorageIndexFilter_Call struct {
	*mock.Call
}
...
func (_e *Initializer_Expecter) RegisterStorageIndexFilter(indexName interface{}, fn interface{}) *Initializer_RegisterStorageIndexFilter_Call {
	return &Initializer_RegisterStorageIndexFilter_Call{Call: _e.mock.On("RegisterStorageIndexFilter", indexName, fn)}
}

func (_c *Initializer_RegisterStorageIndexFilter_Call) Run(run func(indexName string, fn func(context.Context, runtime.Logger, *sql.DB, runtime.NakamaModule, *runtime.StorageWrite) bool)) *Initializer_RegisterStorageIndexFilter_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *Initializer_RegisterStorageIndexFilter_Call) Return(_a0 error) *Initializer_RegisterStorageIndexFilter_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Initializer_RegisterStorageIndexFilter_Call) RunAndReturn(run func(string, func(context.Context, runtime.Logger, *sql.DB, runtime.NakamaModule, *runtime.StorageWrite) bool) error) *Initializer_RegisterStorageIndexFilter_Call {
	_c.Call.Return(run)
	return _c
}
