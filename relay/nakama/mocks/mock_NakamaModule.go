...
//   - limit int
//   - cursor string
func (_e *NakamaModule_Expecter) LeaderboardList(categoryStart interface{}, categoryEnd interface{}, limit interface{}, cursor interface{}) *NakamaModule_LeaderboardList_Call {
	return &NakamaModule_LeaderboardList_Call{Call: _e.mock.On("LeaderboardList", categoryStart, categoryEnd, limit, cursor)}
}

func (_c *NakamaModule_LeaderboardList_Call) Run(run func(categoryStart int, categoryEnd int, limit int, cursor string)) *NakamaModule_LeaderboardList_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *NakamaModule_LeaderboardList_Call) RunAndReturn(run func(int, int, int, string) (*api.LeaderboardList, error)) *NakamaModule_LeaderboardList_Call {
	_c.Call.Return(run)
	return _c
}
...
//   - limit int
//   - cursor string
func (_e *NakamaModule_Expecter) StorageList(ctx interface{}, userID interface{}, collection interface{}, limit interface{}, cursor interface{}) *NakamaModule_StorageList_Call {
	return &NakamaModule_StorageList_Call{Call: _e.mock.On("StorageList", ctx, userID, collection, limit, cursor)}
}

func (_c *NakamaModule_StorageList_Call) Run(run func(ctx context.Context, userID string, collection string, limit int, cursor string)) *NakamaModule_StorageList_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *NakamaModule_StorageList_Call) RunAndReturn(run func(context.Context, string, string, int, string) ([]*api.StorageObject, string, error)) *NakamaModule_StorageList_Call {
	_c.Call.Return(run)
	return _c
}
