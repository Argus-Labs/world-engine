...
# fills the account associated with the mnemonic above with more tokens. first line replaces the address.
...
# this line replaces the balances. its a 0x encoded number.
