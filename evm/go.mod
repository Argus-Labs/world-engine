...
replace (
	...
	github.com/berachain/polaris/cosmos => github.com/argus-labs/polaris/cosmos v1.1.3-hooks
...
require (
	...
	github.com/rollkit/cosmos-sdk-starter v0.0.0-20240508141245-03d41d81903d // indirect
