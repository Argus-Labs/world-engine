...
require (
	...
	pkg.world.dev/world-engine/rift v1.1.0-beta.0.20240326164912-453f6a19d34d
)
...
require (
	...
	pkg.berachain.dev/polaris/contracts v0.0.0-20231104204753-faadca38b64d // indirect
